...
namespace TransCanada.Controllers
{
    ...
    public class EventController : Controller
    {
        ...
        public static List<SelectListItem> ListLocationName()
        {
            ...
            string query = "Select Location_Id,Location as Locations_LocationName from  demo_location_table where company_id=@Accounts_Id";
            SqlCommand cmd = new SqlCommand(query, con);
        ...
        public static List<SelectListItem> GetLocation(string Type, string Name)
        {
            ...
            if (!string.IsNullOrEmpty(Name) && !string.IsNullOrEmpty(Type))
            {
                if (Type == "Lab")
                {
                    ...
                    string query = "Select Id,Location_Id as Address from  tbl_Clinic_Details where Location_Name=@Location_Name and isdeleted=0 and islocationdeleted=0";
                    SqlCommand cmd = new SqlCommand(query, con);
...

                {
                    ...
                    string query1 = "Select Serviceprovider_Id,Location as Address  from Tbl_service_location where Serviceprovider_Name=@name";
                    SqlCommand cmd1 = new SqlCommand(query1, con);
