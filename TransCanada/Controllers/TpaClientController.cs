...
namespace TransCanada.Controllers
{
    ...
    public class TpaClientController : Controller
    {
        ...
        public ActionResult CreateTPaClient(TPAClient Tpa)
        {
            ...
            if (Tpa.TPA_Client != null)
                cmd.Parameters.AddWithValue("@TPA_Client", Tpa.TPA_Client);
            else
                Tpa.TPA_Client = string.Empty;
            if (Tpa.FirstName != null)
                cmd.Parameters.AddWithValue("@FirstName", Tpa.FirstName);
            else
                Tpa.FirstName = string.Empty;
            if (Tpa.Location_id != null)
                cmd.Parameters.AddWithValue("@Location_id", Tpa.Location_id);
            else
                Tpa.Location_id = string.Empty;
                Con.Open();
            cmd.ExecuteNonQuery();
            Con.Close();
        ...
        public ActionResult TpaClientEdit(string id)
        {
            ...
            if (dataTable.Rows.Count > 0)
            {
                ...
                TPA.FirstName = string.IsNullOrEmpty(dataTable.Rows[0]["FirstName"].ToString()) ? string.Empty : dataTable.Rows[0]["FirstName"].ToString();
        ...
        public ActionResult TpaClientEdit(TPAClient TPA)
        {
            ...
            if (TPA.FirstName != null)
                sqlCommand.Parameters.AddWithValue("@FirstName", TPA.FirstName);
            else
                TPA.FirstName = string.Empty;
            if (TPA.Location_id != null)
