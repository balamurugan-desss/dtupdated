...
namespace TransCanada.Controllers
{
    ...
    public class LabController : Controller
    {
        ...
        public ActionResult Delete(string id)
        {
            if (id != null)
            {
                SqlCommand sqlCommand = new SqlCommand("delete_Lab_details", this.conn);
                sqlCommand.CommandType = CommandType.StoredProcedure;
        ...
        {
            TempData["Lab_Name"] = getnamebyid(Convert.ToInt32(id));
        ...
        public ActionResult NewLab(lab_loc_name lab_Loc_Name)
        {
            ...
            foreach (string value in lab_Loc_Name.Lab_Type)
            {
                ...
                if (lab_Loc_Name.Type == null)
                {
                    lab_Loc_Name.Type = string.Empty;
            ...
            sqlCommand.Parameters.AddWithValue("@location_id", (object)lab_Loc_Name.location_id);
            sqlCommand.Parameters.AddWithValue("@firstname", lab_Loc_Name.firstname);
            if (lab_Loc_Name.Type != null)
                sqlCommand.Parameters.AddWithValue("@Type", (object)lab_Loc_Name.Type);
            else
                sqlCommand.Parameters.AddWithValue("@Type", string.Empty);
            if (lab_Loc_Name.Lab_Type != null)
                sqlCommand.Parameters.AddWithValue("@Lab_Type", values);
            else
                sqlCommand.Parameters.AddWithValue("@Lab_Type", string.Empty);
            ...
            if (lab_Location.Address_2 == null)
            {
                lab_Location.Address_2 = string.Empty;
            }
            if (lab_Location.City == null)
            {
                lab_Location.City = string.Empty;
            ...
            SqlCommand Command = new SqlCommand("Proc_Create_Lab", this.conn);
            Command.CommandType = CommandType.StoredProcedure;
            Command.Parameters.AddWithValue("@Location_Name", (object)lab_Loc_Name.Lab_Name);
            Command.Parameters.AddWithValue("@Address_1", (object)lab_Location.Address_1);
            Command.Parameters.AddWithValue("@Location_Id", (object)lab_Loc_Name.location_id);
            Command.Parameters.AddWithValue("@Address_2", (object)lab_Location.Address_2);
            Command.Parameters.AddWithValue("@City", (object)lab_Location.City);
            Command.Parameters.AddWithValue("@State", (object)lab_Location.State);
            Command.Parameters.AddWithValue("@Zip", (object)lab_Location.Zip);
            Command.Parameters.AddWithValue("@Country", (object)lab_Location.Country);
            ...
            {
                Command.Parameters.AddWithValue("@Notes", (object)lab_Location.Notes);
            }
            //sqlCommand.Parameters.AddWithValue("@companyid", Session["Account_id"]);
            conn.Open();
            ...
            conn.Close();
            Lab_contact _Contact = new Lab_contact();
            if (_Contact.Email1 == null)
            {
                _Contact.Email1 = string.Empty;
            }
            if (_Contact.Phone1 == null)
            {
                _Contact.Phone1 = string.Empty;
            }
            if (_Contact.Role == null)
            {
                _Contact.Role = string.Empty;
            }
            if (_Contact.Title == null)
            {
                _Contact.Title = string.Empty;
            }
            if (_Contact.officephone == null)
            {
                _Contact.officephone = string.Empty;
            }
            if (lab_Loc_Name.firstname == null)
            {
                lab_Loc_Name.firstname = string.Empty;
            }
            if (_Contact.Lastname == null)
            {
                _Contact.Lastname = string.Empty;
            }
            if (_Contact.Notes == null)
            {
                _Contact.Notes = string.Empty;
            }
            if (_Contact.Third_Phone == null)
            {
                _Contact.Third_Phone = string.Empty;
            }
            if (_Contact.cell == null)
            {
                _Contact.cell = string.Empty;
            }
            ...
            SqlCommand Command1 = new SqlCommand("proc_insert_Lab_contact", this.conn);
            Command1.CommandType = CommandType.StoredProcedure;

            Command1.Parameters.AddWithValue("@lab_location_Id", Id);
            Command1.Parameters.AddWithValue("@Email1", _Contact.Email1);
            Command1.Parameters.AddWithValue("@Phone1", _Contact.Phone1);
            Command1.Parameters.AddWithValue("@Role", _Contact.Role);
            Command1.Parameters.AddWithValue("@cell", _Contact.cell);
            Command1.Parameters.AddWithValue("@Title", _Contact.Title);
            Command1.Parameters.AddWithValue("@Notes", _Contact.Notes);
            Command1.Parameters.AddWithValue("@firstname", lab_Loc_Name.firstname);
            Command1.Parameters.AddWithValue("@lastname", (object)_Contact.Lastname);
            Command1.Parameters.AddWithValue("@email", (object)_Contact.email);
            Command1.Parameters.AddWithValue("@officephone", (object)_Contact.officephone);
            Command1.Parameters.AddWithValue("@Third_Phone", (object)_Contact.Third_Phone);
        ...
        {
            TempData["Lab_Name"] =getlabname_bycon_id(id);
            TempData["Lab_location"] =getlocname_bycon_id(id);
        ...
        public ActionResult UpdateSubService(int id)
        {
            ...
            if (sqlDataReader.HasRows)
            {
                while (sqlDataReader.Read())
                {
                    ...
                    {
                        subServices.Drugs = sqlDataReader["Drugs"].ToString().Split(',');
                    }
                    else
                    {
                        subServices.Drugs = string.Empty.Split(',');
                    }
                    ...
                    if (!string.IsNullOrEmpty(sqlDataReader["AccountNumber"].ToString()))
                    {
                        subServices.AccountNumber = Convert.ToInt64(sqlDataReader["AccountNumber"].ToString());
                    }
                    else
                    {
                        subServices.AccountNumber = 0;
                    }
                }
                sqlDataReader.Close();
                conn.Close();
        ...
        public ActionResult UpdateSubService(SubServices subServices)
        {
            ...
            sqlCommand.Parameters.AddWithValue("@Drugs", ConvertStringArrayToString(subServices.Drugs));
            ...
            if (!string.IsNullOrEmpty(Convert.ToInt64(subServices.AccountNumber).ToString()))
                sqlCommand.Parameters.AddWithValue("@AccountNumber", (object)subServices.AccountNumber);
            else
                sqlCommand.Parameters.AddWithValue("@AccountNumber", string.Empty);
            conn.Open();
            sqlCommand.ExecuteNonQuery();
            conn.Close();
        ...
        public string getlabnamebyid(int id)
        {
            string name;
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["TransCanadaConnection"].ConnectionString);
            SqlCommand cmd = new SqlCommand("select dbo.GetLabnameById (@ID)", con);
            cmd.Parameters.AddWithValue("@ID", id);
            con.Open();
            name = Convert.ToString(cmd.ExecuteScalar());
            con.Close();
        ...
        public string getlocname_bycon_id(int id)
        {
            string name;
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["TransCanadaConnection"].ConnectionString);
            SqlCommand cmd = new SqlCommand("select dbo.Getlab_location_BycontactId (@ID)", con);
            cmd.Parameters.AddWithValue("@ID", id);
            con.Open();
            name = Convert.ToString(cmd.ExecuteScalar());
            con.Close();
        ...
        public string getlabname_bycon_id(int id)
        {
            string name;
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["TransCanadaConnection"].ConnectionString);
            SqlCommand cmd = new SqlCommand("select dbo.Getlab_name_BycontactId (@ID)", con);
            cmd.Parameters.AddWithValue("@ID", id);
            con.Open();
            name = Convert.ToString(cmd.ExecuteScalar());
            con.Close();
