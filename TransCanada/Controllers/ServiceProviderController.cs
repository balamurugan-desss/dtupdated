       ...
       [BreadCrumb(Clear =true, Label = "ProviderList")]
        ...
        public ActionResult CreateProvider(Service_provider Service, HttpPostedFileBase file)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(Service.Location))
                    sqlCommand.Parameters.AddWithValue("@Location", (object)Service.Location);
                else
                    sqlCommand.Parameters.AddWithValue("@Location", (object)string.Empty);
                ...
                sqlCommand.ExecuteNonQuery();
                connection.Close();
                SqlCommand Command = new SqlCommand("Tbl_service_location_insert", connection);
                Command.CommandType = CommandType.StoredProcedure;
                if (!string.IsNullOrEmpty(Service.Serviceprovider_Name))
                    Command.Parameters.AddWithValue("@Serviceprovider_Name", (object)Service.Serviceprovider_Name);
                else
                    Command.Parameters.AddWithValue("@Serviceprovider_Name", (object)string.Empty);
                //if (!string.IsNullOrEmpty(Service.Contact_Person))
                //    sqlCommand.Parameters.AddWithValue("@Contact_Person", (object)Service.Contact_Person);
                //else
                //    sqlCommand.Parameters.AddWithValue("@Contact_Person", (object)string.Empty);
                if (!string.IsNullOrEmpty(Service.Address_1))
                    Command.Parameters.AddWithValue("@Address_1", (object)Service.Address_1);
                else
                    Command.Parameters.AddWithValue("@Address_1", (object)string.Empty);
                if (!string.IsNullOrEmpty(Service.Address_2))
                    Command.Parameters.AddWithValue("@Address_2", (object)Service.Address_2);
                else
                    Command.Parameters.AddWithValue("@Address_2", (object)string.Empty);
                if (!string.IsNullOrEmpty(Service.City))
                    Command.Parameters.AddWithValue("@City", (object)Service.City);
                else
                    Command.Parameters.AddWithValue("@City", (object)string.Empty);
                if (!string.IsNullOrEmpty(Service.State))
                    Command.Parameters.AddWithValue("@State", (object)Service.State);
                else
                    Command.Parameters.AddWithValue("@State", (object)string.Empty);
                if (!string.IsNullOrEmpty(Service.Zip))
                    Command.Parameters.AddWithValue("@Zip", (object)Service.Zip);
                else
                    Command.Parameters.AddWithValue("@Zip", (object)string.Empty);
                if (!string.IsNullOrEmpty(Service.Country))
                    Command.Parameters.AddWithValue("@Country", (object)Service.Country);
                else
                    Command.Parameters.AddWithValue("@Country", (object)string.Empty);
                if (!string.IsNullOrEmpty(Service.WebSite))
                    Command.Parameters.AddWithValue("@WebSite", (object)Service.WebSite);
                else
                    Command.Parameters.AddWithValue("@WebSite", (object)string.Empty);
                if (!string.IsNullOrEmpty(Service.Location))
                    Command.Parameters.AddWithValue("@Location", (object)Service.Location);
                else
                    Command.Parameters.AddWithValue("@Location", (object)string.Empty);

                if (!string.IsNullOrEmpty(Service.Notes))
                    Command.Parameters.AddWithValue("@Notes", (object)Service.Notes);
                else
                    Command.Parameters.AddWithValue("@Notes", (object)string.Empty);
                connection.Open();
                //Command.ExecuteNonQuery();
                int Serviceprovider_id = (int)Command.ExecuteScalar();
                connection.Close();
                //=====================
                Lab_contact SpContact = new Lab_contact();
                SqlCommand sqlCommand1 = new SqlCommand("Tbl_Sp_Contact_insert", connection);
                sqlCommand1.CommandType = CommandType.StoredProcedure;
                sqlCommand1.Parameters.AddWithValue("@Sp_location_id", Serviceprovider_id);



                if (Service.Email != null)
                    sqlCommand1.Parameters.AddWithValue("@email", (object)Service.Email);
                else
                    sqlCommand1.Parameters.AddWithValue("@email", string.Empty);
                if (Service.Phone1 != null)
                    sqlCommand1.Parameters.AddWithValue("@cell", (object)Service.Phone1);
                else
                    sqlCommand1.Parameters.AddWithValue("@cell", string.Empty);
                if (Service.Last_Name != null)
                    sqlCommand1.Parameters.AddWithValue("@Lastname", (object)Service.Last_Name);
                else
                    sqlCommand1.Parameters.AddWithValue("@Lastname", string.Empty);
                if (Service.First_Name != null)
                    sqlCommand1.Parameters.AddWithValue("@firstname", (object)Service.First_Name);
                else
                    sqlCommand1.Parameters.AddWithValue("@firstname", string.Empty);
                if (Service.Phone2 != null)
                    sqlCommand1.Parameters.AddWithValue("@officephone", (object)Service.Phone2);
                else
                    sqlCommand1.Parameters.AddWithValue("@officephone", string.Empty);
                if (Service.Title != null)
                    sqlCommand1.Parameters.AddWithValue("@Title", (object)Service.Title);
                else
                    sqlCommand1.Parameters.AddWithValue("@Title", string.Empty);
                if (SpContact.Role != null)
                    sqlCommand1.Parameters.AddWithValue("@Role", (object)SpContact.Role);
                else
                    sqlCommand1.Parameters.AddWithValue("@Role", string.Empty);
                if (Service.Notes != null)
                    sqlCommand1.Parameters.AddWithValue("@Notes", (object)Service.Notes);
                else
                    sqlCommand1.Parameters.AddWithValue("@Notes", string.Empty);
                if (SpContact.Email1 != null)
                    sqlCommand1.Parameters.AddWithValue("@Email1", (object)SpContact.Email1);
                else
                    sqlCommand1.Parameters.AddWithValue("@Email1", string.Empty);
                if (Service.Phone3 != null)
                    sqlCommand1.Parameters.AddWithValue("@Phone1", (object)Service.Phone3);
                else
                    sqlCommand1.Parameters.AddWithValue("@Phone1", string.Empty);
                if (Service.Phone != null)
                    sqlCommand1.Parameters.AddWithValue("@Third_Phone", (object)Service.Phone);
                else
                    sqlCommand1.Parameters.AddWithValue("@Third_Phone", string.Empty);
                connection.Open();
        ...
        public ActionResult UpdateProvider(string id)
        {
            ...
            if (dataTable.Rows.Count > 0)
            {
                ...
                serviceProvider.Serviceprovider_Name = string.IsNullOrEmpty(dataTable.Rows[0]["Serviceprovider_Name"].ToString()) ? string.Empty : dataTable.Rows[0]["Serviceprovider_Name"].ToString();
                serviceProvider.Contact_Person = string.IsNullOrEmpty(dataTable.Rows[0]["Contact_Person"].ToString()) ? string.Empty : dataTable.Rows[0]["Contact_Person"].ToString();
                serviceProvider.Location = string.IsNullOrEmpty(dataTable.Rows[0]["Location"].ToString()) ? string.Empty : dataTable.Rows[0]["Location"].ToString();
        ...
        {
            SqlConnection connection = new SqlConnection(this.TransCanadaConnection);
            SqlCommand sqlCommand = new SqlCommand("delete_sp_details", connection);
            sqlCommand.CommandType = CommandType.StoredProcedure;
