...
namespace TransCanadaDemo.Controllers
{
    ...
    public class LocationController : Controller
    {
        ...
        public ActionResult CreateLocContact(string id)
        {
            TempData["CLient_loc"] = getnamebyid(Convert.ToInt32(id));
            TempData["client_name"] = getclientnamebyid(Convert.ToInt32(id));
            Lab_contact Icontact = new Lab_contact();
            //ClientController clientController = new ClientController();
            //location.Cities = clientController.GetAllCities(string.Empty);
            if (id != null)
                Icontact.location_id = id;
            else
        ...
        {
            TempData["CLient_loc"] = GetLocationnameBycId(id);
